...
public class frm_type extends javax.swing.JDialog {

   traitements.cls_traitement t = new cls_traitement();
    public frm_type(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        t.affichager(tdestination, "select * from ttytpe");
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Mis A jour du type de Mse", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Century", 0, 14))); // NOI18N
        ...
        cls_myBouton1.setText("Mis a jour");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cls_myBouton1, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(106, 106, 106))))
        );
    ...
    private void tdestinationMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tdestinationMouseClicked
        t.selectionType(tdestination, id, nom);        // TODO add your handling code here:
    ...
    private void cls_myBouton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cls_myBouton1ActionPerformed
        t.insererType(id, nom);
        t.affichager(tdestination, "select * from ttytpe");        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_type.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_type dialog = new frm_type(new javax.swing.JFrame(), true);
